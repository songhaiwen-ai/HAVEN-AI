...
- 🏗️ [**02-Agent-Architecture (Agent 核心架构)**](file:///c:/Haven-AI/02-Agent-Architecture/01-What-is-an-Agent.md)
  - Agent 四大支柱、[核心区别对比](file:///c:/Haven-AI/02-Agent-Architecture/02-Chatbot-vs-Workflow-vs-Agent-vs-MultiAgent.md)、[O-T-A-O 循环](file:///c:/Haven-AI/02-Agent-Architecture/03-Agent-Basic-Loop-Observe-Think-Act.md)、[什么时候不该用 Agent](file:///c:/Haven-AI/02-Agent-Architecture/04-When-NOT-to-use-an-Agent.md)、[Anthropic 指南](file:///c:/Haven-AI/02-Agent-Architecture/05-Anthropic-Building-Effective-Agents.md)、[OpenAI 白皮书](file:///c:/Haven-AI/02-Agent-Architecture/06-OpenAI-Practical-Guide-to-Building-Agents.md)、[短笔记卡片](file:///c:/Haven-AI/02-Agent-Architecture/07-Short-Note-Why-Agent-Over-Workflow.md)、[GPT Researcher 纯 Python 开源 Agent 架构拆解](file:///c:/Haven-AI/02-Agent-Architecture/08-GPT-Researcher-Architecture-Study.md)。
- 🛠️ [**03-Frameworks-and-Tools (主流框架与工具)**](file:///c:/Haven-AI/03-Frameworks-and-Tools/README.md)
  - [OpenAI Function Calling 指南](file:///c:/Haven-AI/03-Frameworks-and-Tools/01-OpenAI-Function-Calling-Guide.md)、[Google Gemini Function Calling 权威指南](file:///c:/Haven-AI/03-Frameworks-and-Tools/02-Google-Gemini-Function-Calling-Guide.md)、[Anthropic Claude Tool Use 权威指南](file:///c:/Haven-AI/03-Frameworks-and-Tools/03-Anthropic-Claude-Tool-Use-Guide.md)
  - Stage 2 拓展：[MCP 协议权威指南](file:///c:/Haven-AI/03-Frameworks-and-Tools/04-MCP-Model-Context-Protocol-Guide.md)、[Gemini 代码执行指南](file:///c:/Haven-AI/03-Frameworks-and-Tools/05-Gemini-Code-Execution-Guide.md)、[LlamaIndex RAG Agent 指南](file:///c:/Haven-AI/03-Frameworks-and-Tools/06-LlamaIndex-RAG-Agent-Guide.md)、[LangGraph 状态机 Agent 指南](file:///c:/Haven-AI/03-Frameworks-and-Tools/07-LangChain-LangGraph-Guide.md)。
